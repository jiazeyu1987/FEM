...
- The frontend includes a sophisticated chart rendering system with dual-curve support (blue delta values and yellow brightness percentages)
- Timeline supports zoom/pan/scrub interactions with shaded intervals for event visualization